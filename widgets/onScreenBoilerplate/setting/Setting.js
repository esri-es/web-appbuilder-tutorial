  ...
  function(
    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      startup: function() {
        ...
        config.AvuxiButton = config.AvuxiButton || {}
        config.AvuxiButton.params = config.AvuxiButton.params || {}
      ...
      setConfig: function(config) {
        this.config = config;
        var options = config.AvuxiButton.params;
      ...
      getConfig: function() {
        ...
        var options = this.config.AvuxiButton.params;
